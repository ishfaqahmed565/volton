          ...
          <nav className=' border-gray-200 px-4 lg:px-6 py-2.5  pt-10'>
            <div className='flex flex-wrap justify-between items-center mx-auto max-w-screen-xl'>
              <a href='/' className='flex items-center gap-2'>
                <div className='flex items-center w-[55px] h-[55px] md:w-[75px] md:h-[75px]'>
                  <Image
                    src='/hero-logo.png'
                    alt='me'
                    width='300'
                ...
                <span className='dark:text-white self-center text-[35px] md:text-[55px] leading-[35px] md:leading-[55px] font-bold whitespace-nowrap text-black '>
                  volton
                </span>
              </a>
